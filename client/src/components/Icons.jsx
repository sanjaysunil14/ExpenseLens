// Clean Google Material / Lucide-style vector SVG icon library
...
export const LogoIcon = ({ size = 22, className = "" }) => (
  ...
  >
    <defs>
      <linearGradient id="logoGradA" x1="2" y1="2" x2="22" y2="22" gradientUnits="userSpaceOnUse">
        <stop stopColor="#00f0ff" />
        <stop offset="0.5" stopColor="#6366f1" />
        <stop offset="1" stopColor="#ec4899" />
      </linearGradient>
      <linearGradient id="logoGradB" x1="12" y1="4" x2="12" y2="20" gradientUnits="userSpaceOnUse">
        <stop stopColor="#ffffff" stopOpacity="0.9" />
        <stop offset="1" stopColor="#00f0ff" stopOpacity="0.6" />
      </linearGradient>
    </defs>
    {/* Outer High-Tech Prism Lens Hexagon */}
    <path
    ...
    <path
      d="M12 22V12M12 12L20.66 7M12 12L3.34 7"
      stroke="url(#logoGradA)"
      strokeWidth="1.6"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    {/* Central Precision Optical Core */}
    <circle cx="12" cy="12" r="3.2" fill="url(#logoGradB)" />
    <circle cx="12" cy="12" r="1.4" fill="#030712" />
  </svg>
);
